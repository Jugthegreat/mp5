...
# Define flags
FLAGS = flags.FLAGS
flags.DEFINE_float('lr', 5e-4, 'Learning Rate')  # Faster convergence
flags.DEFINE_float('step_lr', 1e-3, 'Step LR for sampling')  # Balanced Langevin step
flags.DEFINE_integer('num_epochs', 50, 'Number of Epochs')  # Train longer for better results
...
flags.DEFINE_integer('noise_level', 50, 'Number of noise levels')  # More granularity
flags.DEFINE_integer('log_every', 100, 'Frequency of logging the loss')  # Log more frequently
flags.DEFINE_integer('sample_every', 500, 'Frequency for saving generated samples')  # Save less frequently
